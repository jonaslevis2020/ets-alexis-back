"""
Django settings for ets_alexis project.
...
SECRET_KEY = "django-insecure-=8j&jm+s@n37-kxbics7l3!@+^o@f#la8(ep0mu$_=#92y!#n="
...
WSGI_APPLICATION = "ets_alexis.wsgi.application"
